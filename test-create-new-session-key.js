...
async function testCreateNewSessionKey() {
  ...
  try {
    ...
    const createResponse = await fetch(`${BASE_URL}/api/store-gelato-agent-key`, {
      method: 'POST',
    ...
    if (createResult.success) {
      ...
      if (debugResult.success) {
        ...
        console.log('   Has session approval:', debugResult.hasSessionKeyApproval);
        console.log('   Session approval length:', debugResult.sessionKeyApprovalLength);
      } else {
