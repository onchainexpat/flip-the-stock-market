const taskId =
  '0x99b0e6d90bec9cc03f2a41dbde9a10fc79f5b24b8cbc57f6e9f4bc7eef0a4309';
...
async function checkTaskStatus() {
  try {
    ...
    if (response.ok) {
      ...
      console.log(
        '   Created:',
        new Date(taskStatus.creationDate).toLocaleString(),
      );
      ...
      if (taskStatus.transactionHash) {
        ...
        console.log(
          '   Basescan URL:',
          `https://basescan.org/tx/${taskStatus.transactionHash}`,
        );
      }
      ...
      if (taskStatus.lastCheck) {
        console.log(
          '   Last Check:',
          new Date(taskStatus.lastCheck).toLocaleString(),
        );
      }
      ...
      if (taskStatus.executionDate) {
        console.log(
          '   Execution Date:',
          new Date(taskStatus.executionDate).toLocaleString(),
        );
      }
