...
function testCompilation() {
  ...
  try {
    execSync('npx tsc --noEmit src/services/clientSessionKeyService.ts', { stdio: 'inherit' });
  ...
  try {
    execSync('npx tsc --noEmit src/services/zerodevSessionKeyService.ts', { stdio: 'inherit' });
...
async function runTests() {
  ...
  if (process.platform === 'win32') {
    try {
      execSync('powershell.exe -c "[console]::beep(800,300); Start-Sleep -Milliseconds 80; [console]::beep(800,300); Start-Sleep -Milliseconds 80; [console]::beep(800,300)"');
    } catch (e) {
