...
async function main() {
  ...
  console.log("📞 Sending additional", ethers.formatEther(additionalAmount), "ETH to contract...");
  ...
  console.log("📊 Estimated complex transactions this can cover:", estimatedTxns.toString());
