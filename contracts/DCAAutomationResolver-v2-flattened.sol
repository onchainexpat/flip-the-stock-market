[dotenv@17.2.0] injecting env (13) from ../.env.local (tip: 🔐 encrypt with dotenvx: https://dotenvx.com)
...
contract DCAAutomationResolver is Ownable, ReentrancyGuard {
    ...
    function executeOrders(bytes32[] calldata orderIds) external nonReentrant {
        require(msg.sender == owner() || msg.sender == address(this) || authorizedExecutors[msg.sender], "Unauthorized");
