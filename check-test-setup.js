...
async function checkTestSetup() {
  ...
  try {
    ...
    if (balance === 0n) {
      ...
      console.log(
        '1. Go to Base Sepolia Bridge: https://bridge.base.org/deposit',
      );
      ...
      console.log(
        '- Use Alchemy faucet: https://www.alchemy.com/faucets/base-sepolia',
      );
      console.log(
        '- Use QuickNode faucet: https://faucet.quicknode.com/base/sepolia',
      );
      return false;
