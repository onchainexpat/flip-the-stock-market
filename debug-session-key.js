...
async function debugSessionKey() {
  ...
  try {
    ...
    if (data.success) {
      ...
      console.log('Session key approval length:', data.sessionKeyApprovalLength);
      ...
      try {
        ...
        console.log('  Enable signature present:', !!parsedApproval.enableSignature);
        ...
        console.log('Addresses match:', accountAddress?.toLowerCase() === '0x320b2943e26ccbDacE18575e7974EDC200BA4dCE'.toLowerCase());
