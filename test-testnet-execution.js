  ...
  try {
    ...
    try {
      ...
      if (gasPriceResponse.ok) {
        ...
        const gasPrice = Number.parseInt(gasPriceData.result, 16);
        console.log(
          `   Current gas price: ${gasPrice} wei (${gasPrice / 1e9} gwei)`,
        );
        console.log(
          `   Suggested maxFeePerGas: ${gasPrice * 2} wei (${(gasPrice * 2) / 1e9} gwei)`,
        );
      }
    } catch (error) {
