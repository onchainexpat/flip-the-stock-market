...
export const NEXT_PUBLIC_ZERODEV_API_KEY = process.env.NEXT_PUBLIC_ZERODEV_API_KEY;
export const NEXT_PUBLIC_ZERODEV_RPC_URL = process.env.NEXT_PUBLIC_ZERODEV_RPC_URL;
export const NEXT_PUBLIC_BASE_BUNDLER_URL = process.env.NEXT_PUBLIC_BASE_BUNDLER_URL;
export const NEXT_PUBLIC_BASE_PAYMASTER_URL = process.env.NEXT_PUBLIC_BASE_PAYMASTER_URL;
