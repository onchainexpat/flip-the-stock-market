...
export class OwnerAgentPermissionServiceFinal {
  ...
  async authorizeAgentPermissions(
    ...
    try {
      ...
      // Create a basic permission validator using a simple policy structure
  ...
  async createAgentPermissionKey(
    ...
    try {
      ...
      // Deserialize permission account with agent's actual private key
