...
import {
  ...
  SwapMessage,
  SwapToggleButton,
  // SwapToast , // Deprecated in OnchainKit
} from '@coinbase/onchainkit/swap';
import type { Token } from '@coinbase/onchainkit/token';
import { useConnectModal } from '@rainbow-me/rainbowkit';
import html2canvas from 'html2canvas';
// import { FundButton, getOnrampBuyUrl } from '@coinbase/onchainkit'; // Deprecated
...
export default function Page() {
  ...
  const handleCoinbaseWalletClick = useCallback(
                ...
                <div className="flex w-full flex-col items-center justify-center gap-2">
                  <div className="w-full max-w-[450px] relative">
                    <Swap
                      ...
                      // isSponsored={true} // Deprecated prop removed
                    >
                      <SwapAmountInput
                        label="Sell"
                    ...
                    {/* Deprecated FundButton removed - OnchainKit update required
