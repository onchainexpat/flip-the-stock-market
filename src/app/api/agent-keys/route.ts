...
export async function GET(request: Request) {
  try {
    ...
    console.log('🔧 DEBUG: Available methods on serverAgentKeyService:', Object.getOwnPropertyNames(Object.getPrototypeOf(serverAgentKeyService)));
    console.log('🔧 DEBUG: serverAgentKeyService type:', typeof serverAgentKeyService);
    console.log('🔧 DEBUG: getAgentKey type:', typeof serverAgentKeyService.getAgentKey);
