...
export async function generateMetadata({
  params,
}: { params: { imageFilename: string } }): Promise<Metadata> {
  ...
  if (!imageUrl.includes('.public.blob.vercel-storage.com')) {
    console.warn(
      "Constructed image URL doesn't look like a Vercel Blob URL:",
      imageUrl,
    );
  ...
  const title = '💹🧲';
  const description =
    'Check out this SPX6900 vs S&P 500 price comparison from FlipTheStockMarket.com';
  ...
  return (
    ...
    >
      ...
      <p style={{ marginTop: '20px' }}>
        <a href="/" style={{ color: '#ff844a', textDecoration: 'underline' }}>
          Back to FlipTheStockMarket.com
        </a>
      </p>
