...
async function diagnoseAddressMismatch() {
  ...
  console.log(
    'Match original?',
    attempt1Account.address === originalAccount.address,
  );
  ...
  console.log(
    'Match original?',
    attempt2Account.address === originalAccount.address,
  );
  ...
  console.log(
    ...
    attempt3Account.address !== originalAccount.address,
  );
  ...
  console.log(
    '- deployedAccountAddress parameter seems to be for already deployed accounts',
  );
  console.log(
    '- To maintain the same address, you must use the exact same validator configuration',
  );

  // Solution
  console.log('\n💡 Solution for DCA:');
  console.log(
    '1. Store the original validator configuration when creating the wallet',
  );
  console.log(
    '2. When creating session keys, install them as additional plugins',
  );
  console.log('3. Use the original account instance, not create a new one');
  console.log(
    '4. Or use the "agent key" approach where the server holds keys to the original wallet',
  );
}
