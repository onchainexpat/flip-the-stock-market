...
async function listAllOrders() {
  try {
    ...
    console.log(`📊 Found ${smartWalletKeys.length} smart wallet orders and ${openOceanKeys.length} OpenOcean orders`);
      ...
      for (const key of smartWalletKeys) {
        try {
          ...
          if (order) {
            ...
            console.log(`   Amount: ${order.totalAmount} (executed: ${order.executedAmount})`);
