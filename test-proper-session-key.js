...
const ORIGINAL_OWNER_KEY = '0x4c0883a69102937d6231471b5dbb6204fe5129617082792ae468d01a3f362318';
...
async function testProperSessionKey() {
  ...
  try {
    ...
    console.log('   Addresses match:', masterAccount.address.toLowerCase() === EXISTING_SMART_WALLET.toLowerCase());
    
    if (masterAccount.address.toLowerCase() !== EXISTING_SMART_WALLET.toLowerCase()) {
      console.log('❌ Master account does not match existing smart wallet');
      console.log('   This means we need to use a different owner key or approach');
      return;
    }
    ...
    console.log('   Should match existing wallet:', sessionKeyAccount2.address.toLowerCase() === EXISTING_SMART_WALLET.toLowerCase());
